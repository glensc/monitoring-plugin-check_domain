...
get_expiration() {
	...
	BEGIN {
		...
		DATE_Dn_Mn_YYYY_DOT = "[0-9][0-9]?\\.[0-9][0-9]?\\.[0-9][0-9][0-9][0-9]"
		...
		# 1.1.2016 13:36:48
		DATE_Dn_Mn_YYYY_DOT_HH_MM_SS = DATE_Dn_Mn_YYYY_DOT " " HH_MM_DD
	...
	# expires......: 1.1.2013 15:30:13
	/expires\.+:/ && $0 ~ DATE_Dn_Mn_YYYY_DOT_HH_MM_SS {split($(NF-1), a, "."); printf("%s-%s-%s", a[3], a[2], a[1]); exit}
